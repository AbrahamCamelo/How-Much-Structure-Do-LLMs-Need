...
from llm_bibliometric.pipelines import run_pipeline_5
...
def run_pipeline(
    ...
    resolved_output_file = resolve_output_file(
        output_file,
        DESCRIPTION_DIR / "pipeline_5" / provider.lower(),
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Pipeline 5: Bibliographic full-cluster two-step description.")
...
def main() -> int:
    ...
    print(resolve_output_file(args.output_file, DESCRIPTION_DIR / "pipeline_5" / args.provider.lower()))
    return 0

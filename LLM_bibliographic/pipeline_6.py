...
from llm_bibliometric.pipelines import run_pipeline_6
...
def run_pipeline(
    ...
    resolved_output_file = resolve_output_file(
        output_file,
        DESCRIPTION_DIR / "pipeline_6" / provider.lower(),
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Pipeline 6: Bibliographic top-k description.")
...
def main() -> int:
    ...
    print(resolve_output_file(args.output_file, DESCRIPTION_DIR / "pipeline_6" / args.provider.lower()))
    return 0

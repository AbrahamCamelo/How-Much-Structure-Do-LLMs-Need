...
from llm_bibliometric.constants import FULL_RUN_DIR
...
def _default_input_dir(provider: str) -> Path:
    return FULL_RUN_DIR / "evaluations" / provider
...
def build_pipeline_average_evaluations(
    ...
    resolved_input_dir = Path(input_dir) if input_dir is not None else _default_input_dir(canonical_provider)

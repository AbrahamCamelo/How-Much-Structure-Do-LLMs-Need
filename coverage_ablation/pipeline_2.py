...
from llm_bibliometric.pipelines import run_pipeline_2
...
def run_pipeline(
    ...
    resolved_output_file = resolve_output_file(
        output_file,
        DESCRIPTION_DIR / "pipeline_2" / provider.lower(),
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Pipeline 2: Retrieved one-step generation.")
...
def main() -> int:
    ...
    print(resolve_output_file(args.output_file, DESCRIPTION_DIR / "pipeline_2" / args.provider.lower()))
    return 0

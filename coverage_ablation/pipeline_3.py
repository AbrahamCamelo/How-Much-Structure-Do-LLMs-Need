...
from llm_bibliometric.cli_paths import resolve_output_file, resolve_raw_scopus_file
...
from llm_bibliometric.pipelines import run_pipeline_3
...
def run_pipeline(
    ...
    resolved_output_file = resolve_output_file(
        output_file,
        DESCRIPTION_DIR / "pipeline_3" / provider.lower(),
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Pipeline 3: Retrieved two-step generation.")
...
def main() -> int:
    ...
    print(resolve_output_file(args.output_file, DESCRIPTION_DIR / "pipeline_3" / args.provider.lower()))
    return 0

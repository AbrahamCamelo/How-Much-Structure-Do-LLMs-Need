...
from llm_bibliometric.evaluations import compute_coverage_of_corpus
from llm_bibliometric.scopus import load_scopus_csv


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluation 1: Coverage of the corpus.")
...
def main() -> int:
    ...
    result = compute_coverage_of_corpus(
